...
function StackLogo({ tone }: { tone: "flux" | "fx" }) {
  ...
  return (
    <svg viewBox="0 0 96 84" className="h-8 w-8" aria-hidden="true">
      <defs>
        <linearGradient
...
function EcosystemCard({
  ...
  return (
    <div
      className={`group relative flex h-full flex-col rounded-[14px] border border-[#151E30] bg-[#0B0F14] px-8 pb-8 pt-9 transition-all duration-200 hover:-translate-y-[2px] ${cardClassName ?? ""}`}
    >
      {badge ? (
      ...
      <div className="mb-5 flex -translate-x-[2px] items-center justify-center">
        {logo}
      </div>
      <p
        className={`mb-[5px] text-center text-[10px] font-semibold uppercase tracking-[0.12em] ${labelClassName}`}
      >
        {description}
      </p>
      <p className="mb-[8px] text-center text-[20px] font-medium leading-[28px] tracking-[-0.01em] text-[#DDE3F5]">
        {title}
      </p>
      <p className="text-center text-[14px] font-normal leading-[22.75px] text-[#9FB3B8]">
        {body}
      </p>
      {href ? (
        <a
...
export function EcosystemMap() {
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-[1060px] px-8">
        <motion.div
        ...
        >
          <p className="mb-[14px] text-[12px] font-medium uppercase tracking-[0.14em] leading-4 text-[#23C9B9]">
            Ecosystem
          </p>
          <h2 className="mb-[10px] text-[36px] font-semibold leading-[40px] tracking-[-0.02em] text-[#EEF2FF]">
            Part of the Croovi suite
          </h2>
          <p className="mx-auto mb-14 max-w-[720px] text-[18px] font-normal leading-[28px] text-[#6B7C80]">
            ...
            <EcosystemCard
              ...
              logo={
                <img
                  src={crooviSymbol}
                  alt="Croovi symbol"
                  className="-translate-x-[4px] h-8 w-8 object-contain"
                />
              }
            />
          </motion.div>
        ...
        <div className="grid grid-cols-1 gap-[18px] md:grid-cols-3 md:items-stretch">
          <motion.div
            initial={{ opacity: 0, y: 18 }}
            whileInView={{ opacity: 1, y: 0 }}
